...
const Dashboard: React.FC<Props> = ({ photo }) => {
          ...
          <div className="space-y-4 relative z-20">
            <div className="flex justify-between items-end">
              <div>
                ...
                <p className="text-5xl font-black tracking-tighter">8.4<span className="text-sm font-bold text-white/20">/10</span></p>
              </div>
             ...
             {MOCK_RESULTS.slice(0, 3).map((res, i) => (
               <div key={i}>
                 ...
                 <div className="w-full h-1 bg-white/5 mt-2 rounded-full overflow-hidden">
                   <div className="h-full bg-[#00f0ff]" style={{ width: `${res.value}%` }} />
                 </div>
               </div>
             ))}
          </div>
        ...
        <div className="glass p-8 rounded-[2.5rem] bg-[#00f0ff]/5 border-[#00f0ff]/20">
           ...
           <div className="space-y-4">
             ...
             <div className="flex justify-between items-center text-[10px] font-mono font-bold text-white/40">
                ...
                <span className="text-[#00f0ff]">94.2%</span>
             </div>
             <div className="pt-4">
